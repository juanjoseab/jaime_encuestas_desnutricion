...
<div class="span9">
    ...
    <h3>Agregar servicio intra-hospitalario</h3>
    <p>
    ...
    <form  method="post" action="?v=servicio&action=insert" accept-charset="utf-8">
      <label><span class="text-warning">*</span> Nombre:</label>
      <input type="text" class="input-xlarge" name="nombre" placeholder="Nombre del servicio intra-hospitalario" />      
